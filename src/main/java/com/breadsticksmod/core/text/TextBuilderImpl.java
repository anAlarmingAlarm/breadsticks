package com.breadsticksmod.core.text;

import com.breadsticksmod.client.util.ChatUtil;
import com.breadsticksmod.client.util.ItemUtil;
...
class TextBuilderImpl implements TextBuilder {
   protected static Field parts;
   protected static Method ADD_CLICK_EVENT;
   protected static Method ADD_HOVER_EVENT;
   private static int SPACE_WIDTH = -1;
   ...
   static {
      try {
         ...
         //throw new RuntimeException(e); // this try block throws errors on some systems and not on others, breaking everything when it does
                                          // gameplay seems unaffected by removing this line so leaving it like this for now
      }
   }
