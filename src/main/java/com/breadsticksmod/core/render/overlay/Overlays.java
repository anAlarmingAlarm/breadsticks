...
import com.breadsticksmod.core.artemis.ArtemisFeatures;
...
public class Overlays {
   ...
   private static void onGameStart(MinecraftStartupEvent event) {
      BreadsticksFeature.INSTANCE = new BreadsticksFeature();

      if (initComplete) return;

      overlays.forEach(Overlays::register);

      ArtemisFeatures.register(BreadsticksFeature.INSTANCE);
