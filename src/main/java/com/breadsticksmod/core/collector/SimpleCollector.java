package com.breadsticksmod.core.collector;
...
public abstract class SimpleCollector<T, A, R> extends Annotated implements java.util.stream.Collector<T, A, R> {
   public SimpleCollector() {
      super(Optional(new com.breadsticksmod.core.collector.Characteristics() {

         @Override
         public Class<? extends Annotation> annotationType() {
            return com.breadsticksmod.core.collector.Characteristics.class;
         }
   ...
   public Set<Characteristics> characteristics() {
      return Set.of(getAnnotation(com.breadsticksmod.core.collector.Characteristics.class).value());
   }
