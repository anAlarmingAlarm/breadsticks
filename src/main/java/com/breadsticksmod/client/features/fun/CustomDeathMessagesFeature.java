package com.breadsticksmod.client.features.fun;
...
import com.breadsticksmod.client.models.death.messages.events.DeathEvent;
import com.breadsticksmod.client.models.death.messages.functions.PlayFunction;
import com.breadsticksmod.client.models.death.messages.templates.FunctionalTemplate;
import com.breadsticksmod.client.models.death.messages.templates.PlayerTemplate;
...
import static com.breadsticksmod.client.models.war.WarModel.DEATH_REGEX;
...
public class CustomDeathMessagesFeature extends Feature {
   ...
   static {
      ...
      templates.add("^[sphxia]:{player} made love to a cheep cheep. {play(\"breadsticks:cheep.cheep\")}");
